...
# Initial file for Alien Invasion video game. This program uses pygame.
...
class AlienInvasion:
  ...
  def _create_fleet(self):
    ...
    # Determine number of rows of aliens that can fit on the screen.
  ...
  def _update_aliens(self):
    """Update the positions of all aliens in the fleet & check position."""
